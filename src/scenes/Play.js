class Play extends Phaser.Scene{
    ...
    create(){
        ...
        this.eraser = new Eraser(this, 0 , 200,'pencil').setOrigin(0,0);
        ...
        //this.physics.add.collider(this.player, this.letterspawner.lettersGroup, this.addToAttempt(this.player,this.letterspawner.lettersGroup));
